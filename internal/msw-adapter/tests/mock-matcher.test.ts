...
describe("Mock Matcher", () => {
  ...
  describe("Method and URL combination", () => {
    it("should require both method and URL to match", () => {
      ...
      const getUsers = findMatchingMock(
        mocks,
        "GET",
        "https://api.example.com/users",
      );
      const postPosts = findMatchingMock(
        mocks,
        "POST",
        "https://api.example.com/posts",
      );
      const wrongMethod = findMatchingMock(
        mocks,
        "POST",
        "https://api.example.com/users",
      );
      const wrongUrl = findMatchingMock(
        mocks,
        "GET",
        "https://api.example.com/posts",
      );
