...
import type { MockResponse } from '@scenarist/core';
...
export const buildResponse = async (
  ...
  // but MockResponse.body is typed as 'unknown' to maintain
  // framework-agnostic serialization in core package. The body is guaranteed
  // to be JSON-serializable by MockResponse design contract. We do not
