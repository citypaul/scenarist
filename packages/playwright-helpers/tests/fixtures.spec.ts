...
scenaristTest.describe('Scenarist Fixtures', () => {
  scenaristTest.describe('scenaristTestId fixture', () => {
    scenaristTest('should generate unique test ID for each test', async ({ scenaristTestId }) => {
    ...
    scenaristTest('should generate different test ID than previous test', async ({ scenaristTestId }) => {
  ...
  scenaristTest.describe('switchScenario fixture - configuration reading', () => {
    ...
    scenaristTest('should read baseURL from Playwright config', async ({ page, switchScenario }) => {
    ...
    scenaristTest('should read scenaristEndpoint from config', async ({ page, switchScenario }) => {
    ...
    scenaristTest('should use default endpoint when not configured', async ({ page, switchScenario }) => {
  ...
  scenaristTest.describe('switchScenario fixture - per-test overrides', () => {
    ...
    scenaristTest('should allow per-test baseURL override', async ({ page, switchScenario }) => {
    ...
    scenaristTest('should allow per-test endpoint override', async ({ page, switchScenario }) => {
    ...
    scenaristTest('should allow both baseURL and endpoint override', async ({ page, switchScenario }) => {
      await switchScenario(page, 'testScenario', {
        baseURL: BASE_URL,
        endpoint: '/custom-endpoint',
      });
  ...
  scenaristTest.describe('switchScenario fixture - test ID injection', () => {
    ...
    scenaristTest('should automatically inject test ID', async ({ page, switchScenario, scenaristTestId }) => {
  ...
  scenaristTest.describe('switchScenario fixture - error handling', () => {
    ...
    scenaristTest('should throw error when baseURL not configured and not provided', async ({ page, switchScenario }) => {
