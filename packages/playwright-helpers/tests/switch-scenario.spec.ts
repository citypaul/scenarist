...
test.describe("switchScenario - Playwright Integration", () => {
  test.describe("successful scenario switching", () => {
    test("should switch to specified scenario successfully", async ({
      page,
    }) => {
    ...
    test("should generate unique test ID with scenario name", async ({
      page,
    }) => {
  ...
  test.describe("error handling", () => {
    ...
    test("should throw error when scenario switch fails with 400", async ({
      page,
    }) => {
      await expect(
    ...
    test("should throw error when scenario switch fails with 500", async ({
      page,
    }) => {
      await expect(
  ...
  test.describe("test ID uniqueness", () => {
    test("should generate different test IDs for different scenarios", async ({
      page,
      context,
    }) => {
    ...
    test("should generate different test IDs for same scenario called multiple times", async ({
      page,
      context,
    }) => {
      const page2 = await context.newPage();
