 ...
 *
 * NOTE: This is NOT a Scenarist feature. This provides the same isolation
 * model as Scenarist's HTTP mocking:
...
import type { UserRepository, User, CreateUserInput } from './user-repository.js';
