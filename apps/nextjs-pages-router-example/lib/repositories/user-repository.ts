 ...
 *
 * NOTE: This is NOT a Scenarist feature. The repository pattern abstracts
 * database access behind interfaces, enabling different implementations for
 * production (Prisma) and tests (in-memory with test ID isolation).
 *
