 ...
 *
 * **Why?** Next.js getServerSideProps and API routes run immediately on
 * server startup. Without this instrumentation hook, MSW won't be initialized
 * before your pages try to fetch data, causing real HTTP requests instead
 * of mocked responses.
 *
 * **Setup Instructions:**
 ...
 *
 * This ensures MSW is ready before getServerSideProps or API routes execute.
 *
...
export async function register() {
  ...
  // 4. If you deploy API routes to Edge, they won't have Scenarist
