/**
 * Checkout Tests - Phase 8.4 Feature Composition
 *
 ...
 * - Request matching on country (UK = free, US = £10 shipping, FR = £5)
...
test.describe('Checkout - Feature Composition', () => {
  ...
  test('should charge £10 shipping for US orders', async ({ page, switchScenario }) => {
  ...
  test('should charge £5 shipping for EU orders', async ({ page, switchScenario }) => {
    // Switch to checkout scenario
    await switchScenario(page, 'checkout');
    await page.goto('/checkout');
