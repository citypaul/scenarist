...
<CardGrid>
  ...
  <Card title="Response Sequences" icon="list-format">
    Ever tested a polling UI that shows pending → processing → complete? Most tools need complex state management. <a href="/scenarios/response-sequences">Scenarist: three lines of config</a>.
  </Card>
...
<NextJsSingletonExplanation variant="detailed" />
