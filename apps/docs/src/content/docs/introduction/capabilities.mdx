...
:::tip[Need Exact Syntax?]
This page explains **what Scenarist can do** with detailed examples and use cases. For complete syntax reference, see [Scenario Format Reference →](/introduction/scenario-format).
:::
