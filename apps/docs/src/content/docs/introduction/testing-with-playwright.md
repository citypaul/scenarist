...
### 2. Automatic Test ID Management
...
## Advanced: Composing with Custom Fixtures
...
- [Scenario Format →](/introduction/scenario-format) - Learn how to define scenarios
