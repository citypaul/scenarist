...
:::tip[Looking for Feature Examples?]
This page is a **syntax reference** showing how to write scenarios. For detailed feature explanations and real-world use cases, see [Dynamic Capabilities →](/introduction/capabilities).
:::

Scenarist scenarios are **TypeScript objects** that define how external APIs behave during testing. Unlike traditional mocking where you write functions and closures, scenarios are **declarative, serializable data structures**.
