...
<CardGrid>
  ...
  <Card title="Manual QA" icon="approve-check">
    QA engineers can switch scenarios to test specific user journeys without developer assistance. "Show me what happens when payment fails."
  </Card>
...
The DevTools would only be available in development and testing environments. Your production bundle stays clean with zero overhead. Optionally, you could enable it in non-production environments (staging, QA) for stakeholder testing.
