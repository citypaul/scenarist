...
We're exploring a browser-based developer tool for scenario management—a floating panel that lets you switch scenarios without code changes, similar to how WireMock's admin UI lets you inspect and modify stubs at runtime, but designed for the development workflow.
