...
<Aside type="tip" title="See It Working">
...
**Why this matters:** Scenarist handles a Next.js-specific issue for you. Next.js has a [well-documented singleton problem](https://github.com/vercel/next.js/discussions/68572) where webpack bundles modules multiple times, breaking classic singleton patterns. This is compounded by [MSW's challenges with Next.js's process model](https://github.com/mswjs/msw/issues/1644). Without protection, this causes:
