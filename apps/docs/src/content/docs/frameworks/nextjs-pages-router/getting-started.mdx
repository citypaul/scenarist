...
The `getScenaristHeaders` helper extracts the test ID header and respects your configured header names and defaults. It's safe to use in production (returns empty object when scenarist is undefined).
