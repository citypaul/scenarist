...
This testing gap isn't unique to RSC - it applies to all modern full-stack frameworks. See [Why Scenarist?](/introduction/why-scenarist) for the complete picture of how Scenarist addresses server-side HTTP testing across Express, Next.js, Remix, and other frameworks.
</Aside>
