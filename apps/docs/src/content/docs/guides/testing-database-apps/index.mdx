...
**Trade-offs:**
- ⚠️ Requires abstracting database access behind interfaces
- ⚠️ Two implementations to maintain (production + test)
- ⚠️ Test implementation doesn't catch real database issues
