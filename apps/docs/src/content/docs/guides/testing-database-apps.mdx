...
- ❌ Database is required for **authentication/authorization** middleware ([see workarounds below](#auth-middleware-workarounds))
...
## Special Case: Database-Based Authentication in Middleware {#auth-middleware-workarounds}
