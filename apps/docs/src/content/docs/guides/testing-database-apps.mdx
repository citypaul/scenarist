...
description: The honest guide to testing Next.js apps that use databases and external APIs
---

import { Aside, Card, CardGrid } from '@astrojs/starlight/components';

<Aside type="danger" title="Critical: Understanding Scenarist's Scope">

**Scenarist mocks external HTTP APIs, not databases.** This guide explains what works, what doesn't, and the honest solution for testing Next.js apps with databases.
...
## The Honest Solution: Hybrid Testing
...
**Use when:** Your app uses both databases AND external HTTP APIs (most real apps).
...
5. **Combine both for real apps** - Most apps need both databases AND external APIs
6. **API routes that proxy external services work** - The external call is intercepted

The honest approach: **Use Scenarist for what it's designed for (external APIs), and Testcontainers for what it's designed for (databases).**
...
- [Hybrid Testing Example](/guides/testing-database-apps/hybrid-testing-strategy) - Complete working example
