---
title: Scenarist
description: Test complete user journeys in the browser. Your backend actually runs.
---

import { Card, CardGrid } from '@astrojs/starlight/components';

<div class="hero-section">
  <h1 class="hero-title">Test Complete User Journeys in the Browser</h1>
  <p class="hero-tagline">
    Your <strong>Server Components render</strong>. Your <strong>API routes execute</strong>. Your <strong>validation runs</strong>.
    <br/>Only external APIs are mocked.
  </p>

  <div class="hero-buttons">
    <a href="/introduction/quick-start" class="button button-primary">
      Get Started →
    </a>
    <a href="https://github.com/citypaul/scenarist" class="button button-secondary">
      View on GitHub ↗
    </a>
  </div>
</div>
