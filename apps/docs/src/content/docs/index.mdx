...
## Test Real Server Components, Not Mocks

**Next.js Server Components can't be unit tested—they require E2E testing.** But traditional E2E testing with MSW means your Server Components never execute. You're testing mock responses, not your actual rendering logic.

**Scenarist changes this:** Your Server Components render, your API routes process requests, your business logic validates data. Only external API calls (Stripe, SendGrid, etc.) are mocked. Test the actual code that runs in production.
