---
title: Logging
description: Configure and use Scenarist's logging infrastructure for debugging and observability
---
...
Scenarist includes three logger implementations:
...
<CardGrid>
  ...
  <Card title="TestLogger" icon="magnifier">
    Captures logs in memory for programmatic assertions. Verify internal behavior in tests.
  </Card>
</CardGrid>
